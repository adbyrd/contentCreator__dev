 ...
 *
 * Change log:
 *   v2.6.1  — Import fix: cancelStoryboard moved from backend/services/project.web
 *             to backend/storyboard/generateStoryboard.web to align with the
 *             storyboard domain consolidation (project.web.js v2.5.0,
 *             generateStoryboard.web.js v1.3.0). No logic changes.
 */
